...
def main():
    # 文件路径
    train_file = 'dataset/train/evidence_cache_train.pkl'
    val_file = 'dataset/val/evidence_cache_val.pkl'
    test_file = 'dataset/test/evidence_cache_test.pkl'
    
    # 保存路径
    train_save_path = 'dataset/train/alignment_features.pkl'
    val_save_path = 'dataset/val/alignment_features.pkl'
    test_save_path = 'dataset/test/alignment_features.pkl'
